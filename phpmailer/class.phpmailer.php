...
//tratamento de erros
 ...
 function enviar($caminhodoarquivo,$nomedoarquivo)
         {
// Define os dados do servidor e tipo de conex�o
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$mail->IsSMTP(); // Define que a mensagem ser� SMTP
$mail->Host = "200.195.144.163"; // Endere�o do servidor SMTP
$mail->SMTPAuth = true; // Usa autentica��o SMTP? (opcional)
$mail->Username = 'luis.antonio@lpbk.adv.br'; // Usu�rio do servidor SMTP
$mail->Password = '!i24387'; // Senha do servidor SMTP

// Define o remetente
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$mail->From = "luis.antonio@lpbk.adv.br"; // Seu e-mail
$mail->FromName = "Luis Antonio Trindade"; // Seu nome

// Define os destinat�rio(s)
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$mail->AddAddress('luis.antonio@lpbk.adv.br', 'Luis Antonio');
$mail->AddAddress('luis.antonio@lpbkadm.adv.br', 'Luis Antonio');
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$mail->Subject  = $_FILES['foto']['name'][$counter]; // Assunto da mensagem
$mail->Body = $_FILES['foto']['name'][$counter];
$mail->AltBody = "Este � o corpo da mensagem de teste, em Texto Plano! \r\n";

// Define os anexos (opcional)
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
//$mail->AddAttachment("C:\teste1\aloc.txt", "aloc.txt"); 
$mail->AddAttachment( $caminhodoarquivo, $nomedoarquivo);  // Insere um anexo
