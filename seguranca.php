...
$_SG['banco'] = 'hermes2';            // Banco de dados MySQL

$_SG['paginaLogin'] = 'index.html'; // Página de login

$_SG['tabela'] = 'pro_usuarios';       // Nome da tabela onde os usuários são salvos
// ==============================
...
echo $nsenha, $nusuario;
// Monta uma consulta SQL (query) para procurar um usuário
$sql = "SELECT `id_usuario`, `nome_usuario` FROM `".$_SG['tabela']."` WHERE ".$cS." `login_usuario` = '".$nusuario."' AND ".$cS."`senha_usuario` = '".$nsenha."' LIMIT 1";
